-- =====================================================================
-- TERANGA PARTS — VEHICULES D'EXEMPLE (donnees de TEST)
--
-- A coller dans le SQL Editor de Supabase pour remplir le catalogue
-- « Vehicules Coree » tant que l'import Encar n'est pas en place.
--
-- Les valeurs sont volontairement variees (marques, carburants,
-- transmissions, couleurs, annees, kilometrages) afin de pouvoir tester
-- CHAQUE filtre du catalogue.
--
-- source = 'seed_test'  ->  permet de tout retirer proprement plus tard :
--     delete from vehicle_listings where source = 'seed_test';
--
-- Relançable sans risque (on conflict do nothing sur la reference).
-- Les photos sont des placeholders etiquetes ; l'import Encar fournira
-- les vraies photos des annonces.
-- =====================================================================
...
-- 1. SUV diesel automatique, blanc
...
-- 2. SUV diesel automatique, noir, faible km
...
-- 3. SUV essence automatique, gris, kilometrage eleve
...
-- 4. Citadine essence automatique, rouge, tres faible km
...
-- 5. Berline premium essence, bleu nuit
...
-- 6. Pickup diesel MANUELLE, argent, gros kilometrage (test filtre transmission)
...
-- 7. HYBRIDE (test filtre carburant), blanc
...
-- 8. Berline essence ancienne, noir, entree de gamme (test filtre annee)
...
-- Verification : doit afficher 8 lignes
